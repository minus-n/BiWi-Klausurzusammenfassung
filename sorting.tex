...
\newcommand{\SaveQuestion}[2]{
    ...
    \immediate\openout\question=\jobname-question-\thequestions
    \immediate\write\question{\unexpanded{#1}}
    \immediate\closeout\question
...
\NewEnviron{Question}[1]{
    \expandafter\SaveQuestion\expandafter{\BODY@Question\ (#1) \newline}{#1}
}
